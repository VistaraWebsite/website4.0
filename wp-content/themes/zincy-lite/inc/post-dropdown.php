 ...
 */
class Zincy_Lite_Post_Dropdown extends WP_Customize_Control
{
    private $posts = false;
            ...
            ?>
                <label>
                    ...
                    <select data-customize-setting-link="<?php echo $this->id; ?>" name="<?php echo $this->id; ?>" id="<?php echo $this->id; ?>">
                        <option value="" <?php if ( get_theme_mod($this->id) == '' ) echo 'selected="selected"'; ?>><?php echo __( 'Choose Post' , 'zincy-lite' ) ?></option>
