...
function zincy_lite_customizer_themeinfo( $wp_customize ) {
	...
	$zincy_lite_desc_theme_opt .= '<a target="_blank" href="http://8degreethemes.com/wordpress-themes/wimpie-pro">'.__('Wimpie PRO','zincy-lite').'</a> <br />';
	...
	$zincy_lite_desc_theme_opt .= '<a target="_blank" href="'.esc_url('http://8degreethemes.com/wordpress-plugins/8-degree-availability-calendar/').'">'.__('8Degree Availability Calendar','zincy-lite').'</a> <br />';
